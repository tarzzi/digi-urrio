      ...
      <main>
        ...
        <Banner title='Ota yhteyttä' />
          <div id='container' className='my-4 w-4/5 mx-auto'>
            ...
            <form className='grid lg:grid-cols-3 sm:grid-cols-1 gap-2 my-5 mx-auto w-1/2 lomake' acceptCharset="UTF-8" action="https://formsubmit.co/234a581c88e120675a986e900a8ef1b2" method="POST">
